...
translate italiantl adine1_2ec83f33:
    ...
    Ad think b "Credevo ti avessero mandatə via dopo tutto quello che sta accadendo."
...
translate italiantl adine1_1cc03842:
    ...
    Ad "Ecco il tuo ordine. Scusa, si è un po' bagnato, ma dovrebbe andare bene comunque."

# game/adine1.rpy:94
translate italiantl adine1choice1_e6f972e8:

    # Ad "It's raining pretty heavily outside, that's all."
    Ad "Fuori sta piovendo a dirotto, ecco tutto."
...
translate italiantl menadine_a00b0992:
    ...
    n "Aprii il mio contenitore con trepidazione, ma ciò che trovai all'interno non era affatto quello che mi aspettavo. Erano noodles, con pollo e una qualche sorta di salsa."
...
translate italiantl _call_skipcheck_10_1571c3b3:
    ...
    Ad "Davvero? Forse abbiamo solo gli stessi gusti." # "we [all] just share"
...
translate italiantl _call_skipcheck_10_e241a15e:
    ...
    c "Beh, non fate forse risalire le vostre origini agli umani in qualche modo? So bene che genere di reputazione abbiamo nella vostra cultura."
...
translate italiantl _call_skipcheck_10_4ab51b92:
    ...
    c "Esatto. Se credete che gli umani abbiano avuto qualcosa a che vedere con un manufatto creato chissà quanti anni fa, non sarebbe poi un azzardo pensare che possano avervi influenzati anche in altri modi."

# game/adine1.rpy:292
translate italiantl _call_skipcheck_10_9fafc86f:

    # Ad "Even something as simple as this dish? I like that idea."
    Ad "Anche qualcosa di così semplice come questo piatto? Mi piace quest'idea."

# game/adine1.rpy:299
translate italiantl _call_skipcheck_10_24fbdd31:

    # Ad "I thought you just did."
    Ad "A me sembrava di sì." # wording
...
translate italiantl _call_skipcheck_10_d29d4197:
    ...
    c "Capisco. Che mi dici dei passatempi? Ne hai qualcuno?"
...
translate italiantl _call_skipcheck_10_75906cf7:
    ...
    Ad "Beh, non so poi molto di te. In effetti, non sono sicura che ci sia nessuno qui che ti conosce." # "who does KNOW YOU"
...
translate italiantl _call_skipcheck_10_0dce8ee6:
    ...
    Ad "Che cosa facevi prima di venire qui?"
...
translate italiantl _call_skipcheck_10_43ec0d7d:
    ...
    Ad "Faccio Aerobatica, o volo acrobatico. Lo faccio ormai a più riprese da un paio d'anni."

# game/adine1.rpy:379
translate italiantl _call_skipcheck_10_f106bf6f:

    # Ad "Actually, that might not be so far from the truth."
    Ad "In effetti, potrebbe non essere tanto lontano dal vero."
...
translate italiantl _call_skipcheck_10_3a15203a:
    ...
    Ad "Suppongo dipenda dal fatto che tu sia ancora qui quando avrà luogo. Fa parte di un festival che teniamo ogni anno in questa città."

# game/adine1.rpy:409
translate italiantl _call_skipcheck_10_410ee6b4:

    # Ad "Okay, since it is my turn again, well..."
    Ad "Okay, dato che è di nuovo il mio turno, beh..."
...
translate italiantl _call_skipcheck_10_02d2db07:
    ...
    Ad "Questa potrebbe essere una domanda insolita, dunque... Quando hanno detto che sarebbe stato un umano a venire qui, diciamo che mi aspettavo qualcosa di un po' diverso."
...
translate italiantl _call_skipcheck_10_53f42aeb:
    ...
    c "Lo so. [Ry] mi ha raccontato alcune delle credenze più comuni qui."
...
translate italiantl _call_skipcheck_10_93f88486:
    ...
    c "Sì, abbiamo un sacco di miti sui draghi."
...
translate italiantl _call_skipcheck_10_c21eb134:
    ...
    c "Ce n'è davvero troppi da elencare. Alcuni di essi buoni, altri non tanto."
...
translate italiantl _call_skipcheck_10_54e6a0c5:
    ...
    c "Beh, secondo alcuni, siete mostri avidi e divora-uomini, inoltre talvolta associati al male e all'apocalisse."

# game/adine1.rpy:454
translate italiantl _call_skipcheck_10_b7bc313e:

    # Ad "Well, that's not very nice."
    Ad "Beh, non è molto carino."
...
translate italiantl _call_skipcheck_10_db56dd45:
    ...
    c "Phew, buono a sapersi che non siete dei mostri feroci, allora."
...
translate italiantl _call_skipcheck_10_d7e7b442:
    ...
    Ad "Potrei anche abituarmici, anche se sarebbe ancora meglio se fosse tutto vero."
...
translate italiantl _call_skipcheck_10_9fd77ad2:
    ...
    Ad "Ad essere onesti, non so se generalizzare a quel modo sia una così buona idea—anche se quelle che hai detto di noi sono belle cose. Siamo tutti diversi, sai, e non tutti noi siamo gentili." # corrected em-dash
...
translate italiantl _call_skipcheck_10_c249e3f8:
    ...
    Ad "D'altra parte, anche noi abbiamo detto molte belle cose sulla vostra specie."
...
translate italiantl _call_skipcheck_10_0eb9375b:
    ...
    c "Beh, a prescindere da quello che potreste pensare degli umani, posso assicurarti che io non sono in alcun modo speciale o sovrannaturale."

# game/adine1.rpy:478
translate italiantl _call_skipcheck_10_a498f8f9:

    # Ad "I disagree with that."
    Ad "Non sono d'accordo."
...
translate italiantl _call_skipcheck_10_488948a9:
    ...
    c "Lo sai, non hai tutti i torti."
...
translate italiantl _call_skipcheck_10_22fb7d86:
    ...
    c "Ho pensato fosse uno scherzo. Certo, tutto è cambiato una volta che ho attraversato il portale."
...
translate italiantl _call_skipcheck_10_27b32db1:
    ...
    Ad "Vedi, scoprire che qualcosa di cui hai sentito parlare solo nei racconti sia vero è piuttosto speciale."
...
translate italiantl _call_skipcheck_10_aaa0f5f8:
    ...
    c "Non sapevo cosa pensarne. Almeno, finché non sono arrivatə qui e mi sono trovatə davanti uno di voi. E dopodiché, sono solo rimastə senza parole." # see lines 664-666 of chapter 1; "I wasn't sure" -> "I didn't know", "was standing in front of one of you" -> "had one of you stand in front of me"

# game/adine1.rpy:498
translate italiantl _call_skipcheck_10_c9851cf8:

    # Ad "Told you so. It was special for you, too!"
    Ad "Te l'avevo detto. È stato speciale anche per te!"
...
translate italiantl _call_skipcheck_10_821be8f1:
    ...
    Ad "Vedi, non è poi così a senso unico dopotutto, quindi non stupirti se alcuni di noi la pensano allo stesso modo."
...
translate italiantl _call_skipcheck_10_26e8f868:
    ...
    Ad "\"Niente di speciale\" è un buon modo di descrivere l'intera serie, in effetti."
...
translate italiantl _call_skipcheck_10_9df698e3:
    ...
    Ad "Non è solo una storia interessante, è basata su fatti reali. L'autore ha proprio ragione quando dice che possiamo imparare molto da quello che è successo a quei tempi."
...
translate italiantl _call_skipcheck_10_089aa707:
    ...
    Ad "È più che un semplice libro. Suppongo che potrebbe non sembrare così importante a qualcuno che non abbia vissuto qui, comunque." # "doesn't live" -> "hasn't lived"
...
translate italiantl _call_skipcheck_10_9e9eaf83:
    ...
    Ad "D'accordo, dato che prima mi hai chiesto della mia famiglia, credo che farò altrettanto. C'è forse un Sig. o una Sig.ra [player_name] ad attenderti a casa?" # "the same [thing]"

# game/adine1.rpy:582
translate italiantl _call_skipcheck_10_a26d4342:

    # c "No, can't say there is."
    c "No, non posso dire che ci sia."
...
translate italiantl _call_skipcheck_10_d16f87c9:
    ...
    Ad "Che dire di un Sig. o una Sig.ra [player_name] potenziali, allora? Sei in cerca di qualcuno da frequentare?"
...
translate italiantl choicec_8d8ef32c:
    ...
    Ad "Oh. Beh, è un peccato."

# game/adine1.rpy:663
translate italiantl choicec_9e4b6bcd:

    # Ad "No one from around here catch your eye?"
    Ad "Nessuno di queste parti che ha attirato la tua attenzione?"
...
translate italiantl choicee_e3b23a3c:
    ...
    # Ad "Well, who is it?"
    Ad "Beh, di chi si tratta?"

# game/adine1.rpy:688
translate italiantl choicee_e3b23a3c_1:

    # Ad "Well, who is it?"
    Ad "Beh, di chi si tratta?" # see line 680
...
translate italiantl nextsc_e17aa8de:
    ...
    c "Non so bene quante domande fossero quelle, ma sono sicurə che non sia più il tuo turno."

# game/adine1.rpy:701
translate italiantl nextsc_fe09c854:

    # Ad "Are we even still playing this game?"
    Ad "Stiamo ancora giocando a questo gioco?"

# game/adine1.rpy:708
translate italiantl nextsc_98f9c271:

    # Ad "That's true. You seem to be enjoying it, though."
    Ad "Questo è vero. Mi pare che non ti dispiaccia, però."
...
translate italiantl nextsc_20ec6614:
    ...
    c "Continuiamo a porre domande, ma se unə di noi non vuole rispondere alla domanda, dobbiamo fare qualcosa che l'altra persona ci dice di fare."
...
translate italiantl nextsc_4453a933:
    ...
    c "Potrebbe essere qualcosa che mi metterebbe a disagio, o qualcosa che vorresti vedermi fare."
...
translate italiantl nextsc_206795eb:
    ...
    c "Beh, tieni a mente che la rivincita potrebbe arrivare prima di quanto pensi, quindi non chiedere a qualcuno di fare niente che non faresti tu stessa." # "quicker" -> "earlier"

# game/adine1.rpy:739
translate italiantl nextsc_b0e643f3:

    # Ad "Got it. So, who's first?"
    Ad "Afferrato. Quindi, chi è lə primə?"
...
translate italiantl nextsc_deda5e50:
    ...
    Ad "Probabilmente i miei fianchi."
...
translate italiantl nextsc_6c279b9e:
    ...
    Ad "Non faresti cattivo uso di questa informazione, vero?"
...
translate italiantl nextsc_d40811d3:
    ...
    Ad "Non è che abbia dei segreti."

# game/adine1.rpy:762
translate italiantl nextsc_bc038d06:

    # c "That's not a real answer."
    c "Questa non è una vera risposta."
...
translate italiantl nextsc_87f87efc:
    ...
    c "Lo sai, non sei molto brava a questo gioco."

# game/adine1.rpy:766
translate italiantl nextsc_a0221976:

    # Ad "Hey, it's my first time."
    Ad "Ehi, è la mia prima volta."
...
translate italiantl nextsc_b917eced:
    ...
    c "Immagino tu non abbia avuto successo, allora?"
...
translate italiantl nextsc_54608f68:
    ...
    Ad "No, per fortuna non ero troppo in alto quando l'ho fatto, e c'era anche questa grande pozza di fango al suolo proprio dove sono atterrata. Ovviamente c'erano tutti i miei amici a vedere la scena." # "there was ALSO a great puddle"
...
translate italiantl nextsc_818b4ba1:
    ...
    Ad "No. Semmai, mi ha solo spronato a impegnarmi di più."
...
translate italiantl nextsc_bc0926e9:
    ...
    Ad "Questa è tosta. Voglio dire, a quel punto nessuno vedrebbe i miei volteggi, e io voglio che la gente li veda."
...
translate italiantl nextsc_5b659cad:
    ...
    c "Beh, questa domanda era più che altro su cosa faresti se avessi l'opportunità di fare qualcosa senza essere colta sul fatto, come qualcosa di malizioso o di non proprio legale." # "[with] this question"; "criminal" -> "not quite legal"
...
translate italiantl nextsc_d89cde73:
    ...
    Ad "Oh, so cosa farei. Darei un'occhiata all'edificio che hanno trovato assieme al portale."
...
translate italiantl nextsc_81939529:
    ...
    c "Interessante. Credo che anch'io gli darei volentieri un'occhiata."
...
translate italiantl nextsc_6507f194:
    ...
    Ad "Beh, qualche idea ce l'ho su quel che potrebbe accadere in seguito, ma anche se quello che penso non è vero, non ho paura dell'ignoto."
...
translate italiantl nextsc_da6029a2:
    ...
    Ad "Non è divertente, [player_name]."
...
translate italiantl nextsc_ff57023e:
    ...
    Ad "Beh, non lo chiamerei realmente un difetto, ma se potessi cambiare una cosa, probabilmente sarebbero queste strisce sul mio muso."

# game/adine1.rpy:862
translate italiantl nextsc_7bbf2eae:

    # Ad "I don't like them very much."
    Ad "Non mi piacciono granché."
...
translate italiantl nextsc_e3afd84b:
    ...
    Ad "È una domanda molto difficile, lo sai."
...
translate italiantl nextsc_d022c5bd:
    ...
    Ad "Naturalmente mi piacerebbe visitarlo—magari come una sorta di vacanza. Ma se intendi in modo permanente, non sono sicura che potrei prendere e gettarmi tutto quanto alle spalle a quel modo." # corrected em-dash
...
translate italiantl nextsc_a77509ab:
    ...
    Ad "Penso che potrebbe essere il momento per un obbligo adesso."
...
translate italiantl nextsc_0268ca80:
    ...
    Ad "E basta? Non è molto difficile."

# game/adine1.rpy:943
translate italiantl nextsc_dc9a1cef:

    # c "I thought I'd go easy on you, since it is your first time and all."
    c "Ho pensato di andarci piano con te, dato che è la tua prima volta e via dicendo."
...
translate italiantl _call_syscheck_48_9e2d907e:
    ...
    Ad "D'accordo, che diamine. Lo faccio."
...
translate italiantl _call_syscheck_48_38babdee:
    ...
    c "Puoi trovarne uno nella dispensa."
...
translate italiantl _call_syscheck_48_7711fd6d:
    ...
    c "(Non l'ha neanche sbucciato, né altro...)"
...
translate italiantl _call_syscheck_48_e8bc5fde:
    ...
    c "Non ti ha dato alcun fastidio?"
...
translate italiantl _call_syscheck_48_30f9f005:
    ...
    Ad "Beh, allora la mia risposta è no. Non è che io baci chiunque, sai."
...
translate italiantl _call_syscheck_48_5eb2273d:
    ...
    Ad "Comunque, se fosse un obbligo, la mia risposta potrebbe essere diversa."
...
translate italiantl _call_syscheck_48_b1f9f1ed:
    ...
    Ad "D'accordo, perciò di quelli che hai incontrato qui finora, chi è che ti piace di più?"

# game/adine1.rpy:1196
translate italiantl _call_syscheck_48_ad7dc334:

    # c "I think I'll take a dare for this one."
    c "Penso che sceglierò un obbligo per questa."
...
translate italiantl _call_syscheck_48_f69997a6:
    ...
    Ad "Hmm, che cosa potrei farti fare?"
...
translate italiantl _call_syscheck_48_bd0be8be:
    ...
    Ad "No, onestamente non ne ho idea."
...
translate italiantl _call_syscheck_48_7215760e:
    ...
    Ad "D'accordo, fammi pensare per un minuto."
...
translate italiantl _call_syscheck_48_69937dff:
    ...
    Ad "Prendilo come un complimento."
...
translate italiantl _call_syscheck_48_9b53a99d:
    ...
    n "Scomparve con la stessa rapidità con cui era apparsa, ma dato il suo entusiasmo, dubitavo che quella fosse l'ultima volta che avrei avuto sue notizie."
...
translate italiantl adine1skip_a544d69c:
    ...
    Ad "Beh, sei sempre benvenutə a ordinare da mangiare se hai fame."
...
translate italiantl strings:
    ...
    new "Che ti è successo, sei caduta in un fiume o roba simile?"

    # adine1.rpy:92
    old "You're soaked, why don't you come in?"
    new "Sei fradicia, perché non entri?"

    # adine1.rpy:92
    old "Well, thanks for the food."
    new "Beh, grazie per il cibo."
    ...
    new "Questo non è un ricovero per senzatetto."

    # adine1.rpy:212
    old "Yes. I want to skip ahead."
    new "Sì. Voglio saltare avanti."

    # adine1.rpy:212
    old "No. Don't skip ahead."
    new "No. Non saltare avanti."
    ...
    new "Non lo so, {i}puoi{/i}?" # "well" -> "I don't know"

    # adine1.rpy:343
    old "Nothing special."
    new "Niente di speciale."

    # adine1.rpy:343
    old "[[Avoid the question by making a bad pun.]"
    new "[[Schiva la domanda con una pessima battuta.]" # "by making" -> "with"
    ...
    new "Devi essere la volatrice delle consegne più iperqualificata della storia."

    # adine1.rpy:374
    old "That's a cool, but also pretty useless hobby."
    new "È forte, ma anche piuttosto inutile come passatempo."
    ...
    new "Così sai fare tutto questo, ma un po' di pioggia è troppo?"
    ...
    new "Fantastico, dove posso guardarla?"

    # adine1.rpy:413
    old "That's not really a question."
    new "Non è proprio una domanda."

    # adine1.rpy:413
    old "Well, what did you expect?"
    new "Beh, cosa ti aspettavi?"
    ...
    new "Ce n'è troppi da elencare."

    # adine1.rpy:440
    old "Dragons are greedy, man-eating monsters."
    new "I draghi sono mostri avidi e divora-uomini."

    # adine1.rpy:440
    old "Dragons are noble creatures."
    new "I draghi sono nobili creature."

    # adine1.rpy:485
    old "I thought it was a joke."
    new "Ho pensato fosse uno scherzo."

    # adine1.rpy:485
    old "I was unsure."
    new "Non sapevo cosa pensare." # "I was unsure" -> "I didn't know what to think"

    # adine1.rpy:485
    old "I thought it was awesome."
    new "Ho pensato fosse fantastico."

    # adine1.rpy:529
    old "It was entertaining, but nothing special."
    new "Era piacevole, ma niente di speciale."
    ...
    new "Non era proprio il mio genere."

    # adine1.rpy:563
    old "I'm not sure if it's my kind of book."
    new "Non sono sicurə che sia il mio genere di libro."

    # adine1.rpy:563
    old "I'll check it out when I have the time."
    new "Gli darò un'occhiata quando ho tempo."

    # adine1.rpy:563
    old "It's hard for me to find the time to read anything nowadays."
    new "Mi è difficile trovare il tempo di leggere niente in questi giorni."
    ...
    new "Okay, qualcuno c'è."

    # adine1.rpy:634
    old "Well, there's someone."
    new "Beh, qualcuno c'è."
    ...
    new "Beh, sei tu che hai cominciato."

    # adine1.rpy:703
    old "Just having fun."
    new "Mi sto solo divertendo."

    # adine1.rpy:703
    old "Sorry, you gotta play by the rules."
    new "Scusa, ma devi giocare secondo le regole." # "sorry, BUT you gotta play by the rules"

    # adine1.rpy:748
    old "Which part of your body is the most ticklish?"
    new "In quale parte del corpo soffri di più il solletico?"

    # adine1.rpy:748
    old "What is your most guarded secret?"
    new "Qual è il tuo segreto più intimo?"

    # adine1.rpy:748
    old "What's the most embarrassing thing that ever happened to you?"
    new "Qual è la cosa più imbarazzante che ti è mai successa?"

    # adine1.rpy:787
    old "World peace."
    new "La pace nel mondo."

    # adine1.rpy:787
    old "Be the very best, like no one ever was."
    new "Essere lə migliore, come nessuno mai."
    ...
    new "Cosa faresti se fossi invisibile per un giorno?"

    # adine1.rpy:814
    old "Are you scared of dying?"
    new "Hai paura della morte?" # "of dying" -> "of death"

    # adine1.rpy:814
    old "What do you think is your biggest physical flaw?"
    new "Quale pensi sia il tuo più grande difetto fisico?"

    # adine1.rpy:836
    old "That's... interesting."
    new "Questo è... interessante."

    # adine1.rpy:836
    old "To be honest, I feel the same way."
    new "Sinceramente, la penso allo stesso modo."

    # adine1.rpy:836
    old "You know, if you're so eager to find out, I could help you with that."
    new "Lo sai, se sei così ansiosa di scoprirlo, potrei anche darti una mano." # "I could help you [with that]"

    # adine1.rpy:863
    old "I think they're cute."
    new "Io trovo che siano carine."
    ...
    new "Vivrei appieno la mia vita fino all'ultimo istante."
    ...
    new "Mi nasconderei in un rifugio nelle profondità sotterranee."
    ...
    new "Qual è il tuo più grande rimpianto?"

    # adine1.rpy:923
    old "If I asked you to kiss me, would you do it?"
    new "Se ti chiedessi di baciarmi, lo faresti?"

    # adine1.rpy:937
    old "Remove your headgear."
    new "Togliti il copricapo."
