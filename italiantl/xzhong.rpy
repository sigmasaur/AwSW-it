...
translate italiantl _call_skipcheck_31_2cc1d0e9:
    ...
    m "All'improvviso, mi afferrò la mano, si inchinò e vi stampò un umido bacio col muso."
...
translate italiantl _call_skipcheck_31_6c2eb1af:
    ...
    Wr "Salve, [player_name]." # see line 117
...
translate italiantl _call_skipcheck_31_ec1b5bd0:
    ...
    c "Chiedo scusa, ma in effetti non credo che ci siamo ancora presentati come si deve. Come hai detto di chiamarti?"

# game/xzhong.rpy:125
translate italiantl _call_skipcheck_31_371533e6:

    # Wr "You can call me Zhong."
    Wr "Puoi chiamarmi [Zh]."
...
translate italiantl _call_skipcheck_31_ee0aacf5:
    ...
    c "Aspetta, è forse [Br] quello che dorme sotto il tavolo?"
...
translate italiantl _call_skipcheck_31_52471970:
    ...
    c "E questo succede spesso?" # "AND does this happen often"
...
translate italiantl _call_skipcheck_31_e0ed9548:
    ...
    Zh normal b "È difficile dirlo, davvero. Servire al bar è molto più divertente, ma lavorare in negozio paga meglio ed è anche più stabile."
...
translate italiantl _call_skipcheck_31_e025aa4a:
    ...
    c "Almeno in entrambi ti capita di indossare un'uniforme. Non sembra esattamente comune da queste parti."
...
translate italiantl _call_skipcheck_31_8c4f4a51:
    ...
    Zh "Già, di solito sono molto semplici. Questa mi piace, ma dopo un po' il bavero può stringere un po' intorno al collo."
...
translate italiantl _call_skipcheck_31_6d9b3f2f:
    ...
    Zh "Mettersi l'uniforme del negozio è semplicemente un'incombenza. Il berretto, il grembiule—la sento un po' costrittiva." # corrected em-dash; "it [all] feels"
...
translate italiantl _call_skipcheck_31_86c9ae80:
    ...
    m "Fu interrotto da un forte russare che proveniva da sotto il tavolo. Quando guardai in basso, vidi che era [Br] che si rigirava nel sonno."
...
translate italiantl _call_skipcheck_31_392c8ea9:
    ...
    Zh serv b "Se pensi che adesso sia un po' rude, avresti dovuto vederlo da ragazzo. Un vero piantagrane."
...
translate italiantl _call_skipcheck_31_2346ca12:
    ...
    Zh normal b "Ma per qualsiasi cosa puoi contare su di lui. Gli affiderei la mia vita."
...
translate italiantl _call_skipcheck_31_b8b32ad9:
    ...
    c "Sembra che molte persone abbiano fiducia in lui come capo di polizia."

# game/xzhong.rpy:209
translate italiantl _call_skipcheck_31_7b1cc9c3:

    # Zh serv b "They do, and rightfully so."
    Zh serv b "Ce l'hanno, e a buon diritto."
...
translate italiantl _call_skipcheck_31_e0cb7d1b:
    ...
    Zh normal b "Le cose che ha fatto per me personalmente andavano ben più in là dei suoi doveri. Il marchio di un vero amico."
...
translate italiantl _call_skipcheck_31_012f5987:
    ...
    Zh "Oh, è una lunga storia. Ha più a che vedere con me che con lui, in realtà."

# game/xzhong.rpy:217
translate italiantl _call_skipcheck_31_e1926fe6:

    # c "Come on, you can't just start like that and then not spill the beans."
    c "Andiamo, non puoi semplicemente iniziare così e poi non vuotare il sacco."
...
translate italiantl _call_skipcheck_31_6e347fe4:
    ...
    n "In origine la mia famiglia non era di queste parti. Quando avevo otto anni, mio padre trovò lavoro qui, e così ci trasferimmo."
...
translate italiantl _call_skipcheck_31_b958eb09:
    ...
    n "Spostarsi attraverso il continente significava perdere tutti i miei amici, e farne di nuovi non era così semplice per me. Ero giovane, e nuovo, e giusto un po' spaventato."
...
translate italiantl _call_skipcheck_31_a2734d1a:
    ...
    n "Anche allora, [Br] era un tipetto molto curioso, specie quando c'entravano altre persone. Venne da me a scuola, si presentò, e da allora siamo sempre stati amici."
...
translate italiantl _call_skipcheck_31_5a498575:
    ...
    n "Molti anni dopo, [Br] era già in polizia e il mio desiderio di trovare i miei genitori biologici era cresciuto talmente che feci qualche tentativo di ritrovarli."
...
translate italiantl _call_skipcheck_31_19fba955:
    ...
    n "[Br] mosse qualche pedina, e col suo aiuto, fui in grado di rintracciarli. Mi accompagnò persino lungo il viaggio."
...
translate italiantl _call_skipcheck_31_56f87329:
    ...
    "Residente" "Sai che c'è? Non intendo averci a che fare in questo momento. Non ti abbiamo dato via solo perché potessi ripresentarti quando ti pare."

# game/xzhong.rpy:283
translate italiantl _call_skipcheck_31_fb9a3bff:

    # Hu "And don't even think of calling me father."
    Hu "E non ti venga in mente di chiamarmi padre."
...
translate italiantl _call_skipcheck_31_dae933e9:
    ...
    Xu "Non essere villano, Huang. Entra a prendere un tè o qualcosa, va bene?"
...
translate italiantl _call_skipcheck_31_8edfe662:
    ...
    Xu "Ecco, siedi. Andrò a fare un po' di tè." # "I'll go and make [us] some tea"
...
translate italiantl _call_skipcheck_31_70a3a38d:
    ...
    Xu "Non ti va di unirti a noi, Huang?"
...
translate italiantl _call_skipcheck_31_f53df83c:
    ...
    Hu "Sei tu che l'hai invitato. È tuo ospite, non mio. Non voglio averci niente a che vedere."

# game/xzhong.rpy:323
translate italiantl _call_skipcheck_31_7ed6c6f5:

    # Xu "I guess he doesn't want to talk."
    Xu "Immagino che non abbia voglia di parlare."
...
translate italiantl _call_skipcheck_31_05081fac:
    ...
    Zh "Immagino che vent'anni non siano abbastanza." # "20" -> "twenty" for elegance
...
translate italiantl _call_skipcheck_31_6bcd9523:
    ...
    Xu "Ascolta, vorrei dire che mi dispiace, ma so che nulla che io possa dire rimedierà a quello che è successo." # "nothing I say can make up" -> "nothing I can say will make up"
...
translate italiantl _call_skipcheck_31_4a08749e:
    ...
    Xu "Abbiamo dovuto darti via perché eravamo giovani e stupidi. Di questi giorni, non siamo più giovani."
...
translate italiantl _call_skipcheck_31_492e2714:
    ...
    m "Si alzò, si allontanò dal tavolo e scomparve in una stanza diversa. Huang Fu sedeva su di un divano lì vicino davanti al televisore, i suoi occhi incollati allo schermo." # "TV" -> "television" for elegance

# game/xzhong.rpy:355
translate italiantl _call_skipcheck_31_af327d4e:

    # m "After a few moments, Xiuying returned and joined me again."
    m "Dopo qualche istante, Xiuying ritornò e si unì di nuovo a me."
...
translate italiantl _call_skipcheck_31_5089a17b:
    ...
    Xu "Non vorrei chiedertelo, ma non è che ti avanza del denaro? Abbiamo davvero bisogno di cibo e Huang non ama andare a caccia."
...
translate italiantl _call_skipcheck_31_9fc171d7:
    ...
    Zh "Già, forse è ora che me ne vada."
...
translate italiantl _call_skipcheck_31_a3146be9:
    ...
    Hu "E non ti venga in mente di ritornare. Come osi venire qui e disturbarci a quel modo!" with Shake((0, 0, 0, 0), 2, dist=10)

# game/xzhong.rpy:399
translate italiantl _call_skipcheck_31_c24f31c1:

    # Br "Is there a problem here, sir?"
    Br "C'è qualche problema qui, Signore?"

# game/xzhong.rpy:401
translate italiantl _call_skipcheck_31_90a63059:

    # Hu "Who the heck are you?"
    Hu "E tu chi diamine sei?"
...
translate italiantl _call_skipcheck_31_e1b01968:
    ...
    Br "Polizia. Si direbbe che potreste avere qualche problema qui. Può darsi di natura domestica?"
...
translate italiantl _call_skipcheck_31_dd5e3cdf:
    ...
    Xu "Mi dispiace, [Zh]. Non sa quello che sta facendo."

# game/xzhong.rpy:409
translate italiantl _call_skipcheck_31_56ee0791:

    # Zh "I can see that."
    Zh "Me ne sono accorto."
...
translate italiantl _call_skipcheck_31_5454e280:
    ...
    Zh "Penso di aver visto quello che serve."
...
translate italiantl _call_skipcheck_31_ad84d042:
    ...
    Zh "Però, [Br]... Lui per me c'è stato quando allora ho avuto bisogno di lui, e per me c'è ancora oggi." # "he's still there FOR ME today"
...
translate italiantl _call_skipcheck_31_dbf6de84:
    ...
    Zh smile b "Piuttosto bene, direi. Hanno tutti fiducia in lui e pensano stia facendo un ottimo lavoro."
...
translate italiantl _call_skipcheck_31_d516f80b:
    ...
    Zh serv b "Ad ogni modo, mettiamo su un po' di musica. Facciamoci un giro col vecchio jukebox." # wording
...
translate italiantl _call_skipcheck_31_3f237d6c:
    ...
    m "Si alzò e si avvicinò al jukebox all'angolo per guardare la selezione."
...
translate italiantl _call_skipcheck_31_35985209:
    ...
    Zh "Che genere di musica ti piace?"

# game/xzhong.rpy:461
translate italiantl _call_skipcheck_31_484a7cda:

    # Zh "Actually, I'm not sure if your music is in any way similar to ours."
    Zh "In effetti, non sono sicuro se la vostra musica sia in alcun modo simile alla nostra."
...
translate italiantl _call_skipcheck_31_c7e0e48f:
    ...
    Zh serv b "Mettiamo su alcune canzoni diverse e mi dirai tu cosa ne pensi, d'accordo?" # "you'LL tell me"
...
translate italiantl _call_skipcheck_31_168f555e:
    ...
    Zh normal b "Sentiti liberə di scegliere qualsiasi cosa colpisca la tua fantasia."
...
translate italiantl _call_syscheck_109_b0f97ae2:
    ...
    Zh serv b "Ah, qualcosa di semplice. Sai cos'è un pianoforte?"

# game/xzhong.rpy:527
translate italiantl _call_syscheck_109_1479faf4:

    # c "You can play the piano?"
    c "Sai suonare il pianoforte?"
...
translate italiantl _call_syscheck_109_a40d1eba:
    ...
    Zh normal b "Non proprio. Non lo sanno fare in molti, in effetti. Vedi, ci sono molti tipi di strumenti che possono essere suonati solo da certe specie."
...
translate italiantl zhongclassicfinish_53a6e4d9:
    ...
    c "No, voglio dire che l'avevo già sentito prima di aver mai messo piede in questo mondo."
...
translate italiantl zhongclassicfinish_50adbb2c:
    ...
    c "Sembra un po' diverso, ma ci va talmente vicino che non credo sia una coincidenza."
...
translate italiantl zhongclassicfinish_8c0b34a8:
    ...
    c "Dovrò investigare la cosa una volta che sarò ritornatə nel mio mondo."
...
translate italiantl zhongclassicfinish_042430ac:
    ...
    Zh serv b "Senza ulteriori indugi, ecco qua."
...
translate italiantl zhongrockfinish_d5f6429a:
    ...
    Zh "Sì, hai ragione. Forse non per il bar, però."
...
translate italiantl zhongelectronicfinish_f7717c0b:
    ...
    Zh serv b "Questa è un tantino lenta, quindi dovrai aspettare un po' prima che ingrani."
...
translate italiantl zhongorchestralfinish_8cf94083:
    ...
    Zh normal b "Qual è il verdetto?"
...
translate italiantl zhongcont_006ea291:
    ...
    c "A te che genere di musica piace, comunque?"

# game/xzhong.rpy:928
translate italiantl zhongcont_29c654c8:

    # Zh serv b "I like a bit of everything, really."
    Zh serv b "Mi piace un po' di tutto, davvero."
...
translate italiantl zhongcont_56dc7544:
    ...
    Zh smile b "In effetti colleziono ogni genere di musica e accessori, e il jukebox è curato da me."
...
translate italiantl zhongcont_599c8c89:
    ...
    Zh normal b "A volte, la gente dona persino della roba che non gli serve più. Sono abbastanza ben noto per questo fra i clienti abituali."

# game/xzhong.rpy:936
translate italiantl zhongcont_81fc17fb:

    # c "Is the stuff on display over there yours, too?"
    c "Quella in mostra laggiù è anch'essa roba tua?"

# game/xzhong.rpy:938
translate italiantl zhongcont_2b872178:

    # Zh "I'm actually trying to sell those."
    Zh "In effetti quella sto cercando di venderla."

# game/xzhong.rpy:940
translate italiantl zhongcont_7fd1961e:

    # c "You're selling your collection?"
    c "Stai vendendo la tua collezione?"
...
translate italiantl zhongcont_714932fb:
    ...
    Zh "Mi sto solo ridimensionando. Si tratta solo di un lettore e qualche vecchio disco che sto cercando di vendere per il mio fondo vacanze."
...
translate italiantl zhongcont_12b4031c:
    ...
    Zh smile b "Sarà una vacanza di famiglia—solo io e mio figlio. Più che altro per mio figlio, però. Progettiamo di viaggiare attraverso l'intero paese, facendo fermate nelle varie città lungo la strada." # corrected em-dash
...
translate italiantl zhongcont_0a1f1c4b:
    ...
    Zh normal b "Lo pianifico già da un po' ormai e cerco di mettere da parte per organizzarmi. Non abbiamo mai potuto permetterci una vera vacanza quando c'era ancora la madre, e così..." # "really afford a vacation" -> "afford a real vacation"
...
translate italiantl zhongcont_bd25c967:
    ...
    Zh "Allora litigavamo parecchio, su ogni genere di cose. Quando adesso ripenso a quel periodo, sembra come se non avessimo fatto altro. Discutere su cose futili, su cui non c'è bisogno di discutere."

# game/xzhong.rpy:956
translate italiantl zhongcont_5b2d0814:

    # Zh "Of course it's easy to say that after the fact, and when it's already too late."
    Zh "Ovviamente è facile dirlo dopo il fatto, e quando è già troppo tardi."
...
translate italiantl zhongcont_f8eec621:
    ...
    Zh serv b "Ma, sì, ecco perché penso che ci serva questa vacanza—per passare del tempo di qualità assieme." # corrected em-dash
...
translate italiantl zhongcont_94ba98a5:
    ...
    Zh normal b "È anche il motivo per cui ho accettato quel secondo lavoro al negozio di alimentari. Fra qualche mese compirà nove anni e vorrei fargli una sorpresa allora." # "9" -> "nine" for elegance; "I want to surprise him [with it] then"
...
translate italiantl zhongcont_b6368327:
    ...
    Zh smile b "Ha visto questo film in cui una famiglia va in vacanza attraverso il paese e succedono ogni sorta di folli peripezie lungo la strada. Gli era piaciuto così tanto e ogni volta mi chiedeva quando avremmo fatto una vacanza come quella." # "going on" -> "having"

# game/xzhong.rpy:976
translate italiantl zhongcont_877bcb36:

    # Zh normal b "I just want to give that to him. I think he needs it."
    Zh normal b "Vorrei solo dargli questo. Penso che ne abbia bisogno."

# game/xzhong.rpy:978
translate italiantl zhongcont_8af06945:

    # c "You said his birthday is in a few months. Will you be able to afford it?"
    c "Hai detto che il suo compleanno è fra qualche mese. Sarai in grado di permettertelo?" # see line 972
...
translate italiantl zhongcont_0f39c001:
    ...
    c "E se ti comprassi io alcuni di quei dischi?"
...
translate italiantl zhongcont_21dd41e5:
    ...
    c "Dicevi che sono in vendita, giusto?" # see line 942
...
translate italiantl zhongcont_e5e8a342:
    ...
    c "La segnerò come una spesa in merito alla mia visita qui, così sarà tutto sistemato." # "I'll [just] put it down"; "AN expense[s]"
...
translate italiantl zhongcont_b867429f:
    ...
    c "Magari, dopo che mi hai fatto sentire un po' di quella musica, non posso proprio resistere e ho bisogno di avere quei dischi. In effetti, mi servirà anche il lettore, perché dubito che funzioneranno coi nostri lettori a casa."

# game/xzhong.rpy:998
translate italiantl zhongcont_a070115e:

    # c "Besides, I could really use a souvenir."
    c "E poi, mi ci vorrebbe proprio un souvenir."

# game/xzhong.rpy:1000
translate italiantl zhongcont_5f4577a6:

    # Zh "Thank you. Thank you so much."
    Zh "Ti ringrazio. Grazie infinite."

# game/xzhong.rpy:1002
translate italiantl zhongcont_577ecbac:

    # Zh smile b "Let me just get that for you."
    Zh smile b "Lascia che te li prenda."
...
translate italiantl zhongcont_d96ab6a7:
    ...
    Zh "Oh, no. Così sarebbe troppo. Sono tuoi. Prendili, ti prego."
...
translate italiantl zhongcont_617d1d68:
    ...
    Zh normal b "Saranno anche interessanti per l'umanità, ritengo."
...
translate italiantl zhongcont_8e38c321:
    ...
    Zh serv b "Magari in cambio qualche volta puoi mostrarmi della musica umana."
...
translate italiantl zhongcont_5bcb96e7:
    ...
    Zh normal b "Sembravi una bella persona. Volevo sapere come fossi."

# game/xzhong.rpy:1060
translate italiantl zhongcont_6d29dde9:

    # c "Do you kiss the hand of every nice person you meet?"
    c "Baci la mano a tutte le belle persone che incontri?"
...
translate italiantl zhongcont_2cca79ed:
    ...
    Zh serv b "Immagino che mi hai beccato. Il che rende piuttosto evidenti le mie intenzioni, suppongo, anche se so che non durerebbe." # "won't last" -> "wouldn't last"
...
translate italiantl zhongcont_001fc5b3:
    ...
    Zh smile b "E poi, non sono sicuro che lo chiamerei un gioco. Quella è una cosa che farebbe [Br]."
...
translate italiantl zhongcont_4b91d27a:
    ...
    Zh normal b "Io preferisco fare le cose con calma e avere una relazione duratura."
...
translate italiantl zhongcont_8fa1afef:
    ...
    c "Perché mi avresti chiesto di uscire se sapevi che non sarebbe durata, però?"
...
translate italiantl zhongcont_45cadeba:
    ...
    Zh "[Br] mi ha parlato di te, sai. Mi ha fatto capire che devo buttarmi di nuovo."
...
translate italiantl zhongcont_7f03ca5c:
    ...
    Zh serv b "Ho pensato che avresti potuto dirmi di più su come si frequentano gli umani e darmi qualche consiglio."

# game/xzhong.rpy:1112
translate italiantl zhongcont_4dba3c1c:

    # c "I'm not sure if my experience would be worth anything here."
    c "Non sono sicurə che la mia esperienza varrebbe qualcosa."
...
translate italiantl zhongcont_be04310b:
    ...
    Zh normal b "Non puoi che avere una diversa prospettiva di tutto quello che succede qui. Magari tu puoi cogliere aspetti che noi non consideriamo. Vorrei solo sentire la tua opinione." # "haven't considered" -> "don't consider"

# game/xzhong.rpy:1116
translate italiantl zhongcont_b489b5ed:

    # Zh serv b "It's not just about dating, you know."
    Zh serv b "Non solo sul frequentarsi, sai." # "[it's] not just about dating"
...
translate italiantl zhongcont_492aecdd:
    ...
    Zh normal b "D'accordo. Credo che ormai tu abbia avuto un assaggio di come sia [Br] con questo genere di cose. A lui piacciono le tresche. Sembra che abbia qualcuno di nuovo ogni mese." # "every [couple of] month[s]"
...
translate italiantl zhongcont_9b101fd7:
    ...
    Zh "Dovresti vederlo certe notti—la gente non fa che sciamargli intorno. Non lo biasimo per questo, comunque. È uno popolare." # "and how" -> "—"; "guy" -> "one"
...
translate italiantl zhongcont_e3d4538d:
    ...
    Zh "No, non vorrei quello che ha lui, ma trovo difficile anche solo trovare qualcuno." # "one prospective partner" -> "someone" by necessity
...
translate italiantl zhongcont_59179214:
    ...
    Zh serv b "Penseresti che coglierei questi aspetti mentre lavoro, ma poi, tipicamente non sono relazioni a lungo termine quelle che si formano qui."
...
translate italiantl zhongcont_3dff664f:
    ...
    Zh normal b "Non ho esattamente tutto questo tempo libero per buttarmici. Inoltre non ringiovanisco, e non dimenticare che ho già un figlio di cui occuparmi."
...
translate italiantl zhongcont_8773ce08:
    ...
    Zh "Il che non rende le cose più facili, sai. In un certo senso, non frequenti solo la persona, frequenti anche il piccolo, se capisci che intendo."

# game/xzhong.rpy:1136
translate italiantl zhongcont_44785c0a:

    # c "Now that just sounds wrong."
    c "Messa così suona proprio male." # "now" -> "put it like that"; "that just sound wrong" -> "it just sounds wrong"
...
translate italiantl zhongcont_723be07b:
    ...
    Zh "Può rendere le cose alquanto difficili, ecco tutto."
...
translate italiantl zhongcont_0dd53709:
    ...
    c "D'accordo, forse dovremo lavorare sul tuo approccio. Qual è la prima cosa che noti di una persona?"

# game/xzhong.rpy:1144
translate italiantl zhongcont_b7903570:

    # Zh serv b "Their personality."
    Zh serv b "La sua personalità."
...
translate italiantl zhongcont_141b19f7:
    ...
    Zh normal b "Qui incontro così tanta gente ogni giorno. Quando sono dei clienti, la cosa che di loro salta di più agli occhi è sempre come trattano chi li serve."
...
translate italiantl zhongcont_e76afc30:
    ...
    Zh "E poi, le relazioni basate sull'aspetto non mi interessano. Mi piace parlare con le persone e conoscerle in quel modo."
...
translate italiantl zhongcont_8ef4052c:
    ...
    Zh serv b "Il che rende anche tutta la cosa più difficile per me, perché devo investire molto più tempo per scoprire se siamo compatibili."
...
translate italiantl zhongcont_654a08bb:
    ...
    Zh normal b "Sai, se una relazione non funziona per [Br], lui può semplicemente trovarsi qualcun altro il giorno dopo, ma per me questo processo può richiedere alcuni mesi."
...
translate italiantl zhongcont_c8b927f4:
    ...
    c "Non penso esista una ricetta per il successo che io possa darti, però."
...
translate italiantl zhongcont_40c4c5d3:
    ...
    c "Sì. Certo, potrebbe volerci un po' per trovare qualcuno, ma non penso esistano scorciatoie per quel che cerchi di fare. Tu continua così e vedrai che alla fine accadrà." # "keep going" -> "keep it up"
...
translate italiantl zhongcont_bf9f58b2:
    ...
    c "E poi, avrai un po' di tempo per venirne a capo con la vacanza che arriva, giusto?" # "figure things out [for yourself]" -> "figure it out"
...
translate italiantl zhongcont_7ea19d57:
    ...
    Zh smile b "Questo è vero. Sarà un'esperienza illuminante in una serie di modi. Forse il fronte delle relazioni sarà uno di quelli."

# game/xzhong.rpy:1174
translate italiantl zhongcont_0b6df0ac:

    # c "Now that's the right attitude."
    c "Questo è l'atteggiamento giusto."
...
translate italiantl zhongcont_4b2c0688:
    ...
    Zh serv b "E su questa nota, forse dovremmo chiuderla qui per stasera. È piuttosto tardi." # corrected "call it A night"
...
translate italiantl zhongskip_a4cb4984:
    ...
    Zh "Senza contare i consigli, e di aver comprato la mia roba."
...
translate italiantl strings:
    ...
    new "Sei piuttosto carino con quella indosso, però."

    # xzhong.rpy:180
    old "He's a bit rough around the edges, but he seems like a stand up guy."
    new "È un po' spigoloso, ma sembra un tipo affidabile."

    # xzhong.rpy:180
    old "Let's hope his body doesn't start getting rid of any... liquids while he's passed out."
    new "Speriamo non inizi a liberarsi di qualche... liquido mentre è svenuto." # "his body" -> "he"

    # xzhong.rpy:550
    old "Let's try something else."
    new "Proviamo qualcos'altro."

    # xzhong.rpy:564
    old "It's alright. I just want to try something else."
    new "Non è male. Vorrei solo provare qualcos'altro."
    ...
    new "È piuttosto bella."

    # xzhong.rpy:596
    old "Not bad, but I've heard better."
    new "Non male, ma ho sentito di meglio."

    # xzhong.rpy:596
    old "It's pretty bad, to be honest."
    new "È piuttosto brutta, ad essere onesti."

    # xzhong.rpy:777
    old "Not enough action for my taste."
    new "Non c'è abbastanza azione per i miei gusti."

    # xzhong.rpy:777
    old "It makes for nice background music."
    new "Fa da piacevole sottofondo musicale."

    # xzhong.rpy:843
    old "I don't like slow music."
    new "Non mi piace la musica lenta."

    # xzhong.rpy:843
    old "I don't like orchestral music."
    new "Non mi piace la musica orchestrale."

    # xzhong.rpy:843
    old "That was pretty decent."
    new "Questa non era niente male."

    # xzhong.rpy:899
    old "It's not really my kind of music."
    new "Non è proprio il mio genere di musica."
    ...
    new "Io preferisco l'approccio di [Br]."

    # xzhong.rpy:1068
    old "I think both can be fun."
    new "Penso che entrambe possano essere divertenti."
