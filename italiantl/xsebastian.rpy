...
translate italiantl sebastian_5fd3b20a:
    ...
    Sb smile b "Sono ancora in servizio, sai."
...
translate italiantl _call_skipcheck_14_b588e3ed:
    ...
    Sb normal b "Faccio solo il mio lavoro, Signore."
...
translate italiantl _call_skipcheck_14_9c170a5f:
    ...
    Sb shy b "Scusa, colpa mia. Non avevo ancora visto un umano in carne ed ossa prima di oggi, quindi è un po' difficile dirlo."

# game/xsebastian.rpy:143
translate italiantl _call_skipcheck_14_2c14ce99:

    # Sb smile b "Alright."
    Sb smile b "D'accordo."

# game/xsebastian.rpy:152
translate italiantl _call_skipcheck_14_4c1b873d:

    # Sb "Anyway, did you need anything?"
    Sb "Ad ogni modo, avevi bisogno di qualcosa?"
...
translate italiantl _call_skipcheck_14_03efab90:
    ...
    Sb "Magari potrei farti cambiare idea."
...
translate italiantl _call_skipcheck_14_c782fb9c:
    ...
    c "Ma sarà il caso che ce ne andiamo... fuori, e basta?"
...
translate italiantl _call_skipcheck_14_04f2b276:
    ...
    Sb smile b "Si suppone che ti faccia da guardia, sai. Tecnicamente, sono ancora in servizio, ma il campeggio sarebbe molto più divertente che restarsene tu in casa e io a guardia della porta, non credi?" # "your door" -> "the door"
...
translate italiantl _call_skipcheck_14_d3cdd739:
    ...
    Sb "E poi, si suppone che ti accompagni ovunque tu vada. Non sei nostrə prigionierə, quindi ovviamente sei liberə di andare ovunque tu voglia."
...
translate italiantl _call_skipcheck_14_cb8d6bc3:
    ...
    Sb "Se volessi passare una notte all'aperto e sperimentare la campagna, non solo io non potrei fermarti, ma sarei obbligato a venire con te."
...
translate italiantl _call_skipcheck_14_e4381406:
    ...
    Sb "Sicuro. Fammi solo prendere alcune cose."
...
translate italiantl _call_skipcheck_14_b738fedc:
    ...
    Sb drop b "Sul serio? Anche dopo che mi hai chiamato e volevi fare qualcosa?"
...
translate italiantl _call_skipcheck_14_8be257ed:
    ...
    c "Mi sorprende che siamo riusciti a trovare un posto così tardi dopo quello che mi hai detto."
...
translate italiantl _call_skipcheck_14_0740d514:
    ...
    Sb "Con un membro delle forze di polizia e qualcuno che è importante come lo sei tu, non c'è poi da sorprendersi. Probabilmente lo considerano un onore di ospitarci."

# game/xsebastian.rpy:258
translate italiantl _call_skipcheck_14_6e3f3fad:

    # c "So, this is it? No tent, or anything?"
    c "Così, questo è quanto? Niente tenda, o altro?"
...
translate italiantl _call_skipcheck_14_c8ea0a86:
    ...
    Sb normal b "Oh, il campeggio in tenda sarebbe stato un po' più complicato da allestire all'ultimo momento."

# game/xsebastian.rpy:262
translate italiantl _call_skipcheck_14_3775c602:

    # c "Is there any other form of camping?"
    c "Ci sono altre forme di campeggio?"
...
translate italiantl _call_skipcheck_14_26a65c63:
    ...
    Sb "Quello che vedi qui è il campeggio in cava. Essenzialmente sono gestiti come ostelli, ma si dorme in una cava come questa." # "caves" -> "a cave"
...
translate italiantl _call_skipcheck_14_864943b9:
    ...
    Sb smile b "Se volevi un letto comodo, avresti dovuto restartene in camera. Qui si fa sul serio."
...
translate italiantl _call_skipcheck_14_1a71e93f:
    ...
    Sb drop b "Oh, ho capito. Hai la pelle sensibile e tutto il resto. Pensi che sarà un problema?"
...
translate italiantl _call_skipcheck_14_e40d15e5:
    ...
    Sb "Già. Solo noi e la natura stessa."
...
translate italiantl _call_skipcheck_14_075ac730:
    ...
    c "Abbiamo persino della luce naturale qui dentro. Fortuna che si faceva \"sul serio\"."
...
translate italiantl _call_skipcheck_14_c772a5ce:
    ...
    Sb drop b "Lo sai, ero un po' nervoso quando ti ho incontrato per la prima volta."
...
translate italiantl _call_skipcheck_14_802d6bb9:
    ...
    Sb smile b "Mi aveva fatto una certa impressione sentire che gli umani avrebbero visitato il nostro mondo, ma quando ti ho incontrato ed è venuto fuori che eri solo una persona normale, mi ha davvero spiazzato." # "you were just [like] an ordinary person"

# game/xsebastian.rpy:328
translate italiantl _call_skipcheck_14_441b8230:

    # c "Didn't you meet Reza before?"
    c "Non avevi già incontrato [Rz]?"
...
translate italiantl _call_skipcheck_14_5068faf0:
    ...
    Sb normal b "In effetti, no. Tutto riguardo alla vostra visita è avvolto nel segreto, quindi non ho potuto sentire granché di [Rz] da [Mv] prima di incontrarti."
...
translate italiantl _call_skipcheck_14_dfc81f2d:
    ...
    c "Perciò, sei uno di quelli che si aspettavano che mi atteggiassi in un certo modo perché sono umanə?"
...
translate italiantl _call_skipcheck_14_eba66d5c:
    ...
    Sb "In effetti, non aveva tanto a che vedere con quello. Qualunque ospite di alto profilo mi avrebbe reso nervoso, specie se ero io incaricato di proteggerlo."
...
translate italiantl _call_skipcheck_14_fbcc765b:
    ...
    Sb smile b "Ti ringrazio. Farò del mio meglio."
...
translate italiantl _call_skipcheck_14_f664e55f:
    ...
    Sb smile b "Se queste pareti iniziano a incrinarsi, non è per la mia carriera che sarò preoccupato."
...
translate italiantl _call_skipcheck_14_2bf4c17b:
    ...
    c "Da quant'è che sei in polizia? Non mi avranno mica assegnato il novellino, vero?"
...
translate italiantl _call_skipcheck_14_ef8d12b0:
    ...
    c "Suppongo voglia dire che non avete molte nuove reclute."
...
translate italiantl _call_skipcheck_14_acd8c1ea:
    ...
    Sb normal b "Non qui, per lo meno. Questa è solo una piccola città, quindi non ne abbiamo bisogno poi così spesso. Io ho avuto fortuna quando ho avuto la posizione, perché pensavo ci sarebbe stata più competizione dalla gente del luogo."

# game/xsebastian.rpy:380
translate italiantl _call_skipcheck_14_5be5aa63:

    # c "Locals? Don't you live here?"
    c "Del luogo? Non vivi forse qui?"
...
translate italiantl _call_skipcheck_14_73980b4f:
    ...
    Sb "Ci vivo adesso, ma in effetti sono cresciuto in un piccolo villaggio agricolo che consisteva per lo più di corridori come me."
...
translate italiantl _call_skipcheck_14_db27d20e:
    ...
    Sb "Oh, è solo come chiamiamo a volte la nostra specie. Abbiamo zampe piuttosto potenti."
...
translate italiantl _call_skipcheck_14_fc8548d4:
    ...
    c "Ci sono molti villaggi dove gli abitanti sono per lo più della stessa specie?"
...
translate italiantl _call_skipcheck_14_8f13fcf1:
    ...
    Sb "Senza dubbio. Sono più che altro i più piccoli però, perché più grandi diventano, più troverai varietà."
...
translate italiantl _call_skipcheck_14_66471d43:
    ...
    Sb "Ho solo la mia città natale per fare il confronto, ma da quello che ho sentito, ci sono altri villaggi che sono piuttosto simili."
    Sb "Possono sopravvivere in quel modo solo se conducono una vita molto più semplice o se si concentrano su una certa industria in cui quella specie è brava." # split to fit three lines

# game/xsebastian.rpy:398
translate italiantl _call_skipcheck_14_48c20432:

    # c "So your species is good at farming?"
    c "Perciò la tua specie è brava nell'agricoltura?"
...
translate italiantl _call_skipcheck_14_56b5caab:
    ...
    Sb smile b "Meglio dei draghi di terra almeno, anche se fanno comodo nel tirare gli aratri."

# game/xsebastian.rpy:402
translate italiantl _call_skipcheck_14_564d1f0c:

    # c "Why did you decide to become a police officer?"
    c "Come mai hai deciso di diventare un agente di polizia?"
...
translate italiantl _call_skipcheck_14_e57c17da:
    ...
    Sb "Volevo solo vedere quello che c'era là fuori, al di là dei nostri orti, e se qualsiasi cosa c'era fosse come nelle storie che avevo sentito."
...
translate italiantl _call_skipcheck_14_1db23948:
    ...
    c "Ora che me lo dici, non so poi molto nemmeno di questa città."
...
translate italiantl sebastianquestions_6e6fe3ef:
    ...
    c "Dicevo più che altro se avessero una qualche sorta di industria."
...
translate italiantl sebastianquestions_0ca089a1:
    ...
    Sb normal b "Oh, capisco. Questa città in effetti è alquanto unica, perché nonostante sia piuttosto piccola, ha un suo stabilimento di produzione. Con ciò, in pratica abbiamo una nostra catena di produzione completa."
...
translate italiantl sebastianquestions_298177f7:
    ...
    c "Perciò la vostra unica fabbrica è l'orgoglio e la gioia di tutti qui?"
...
translate italiantl sebastianquestions_5a2316f9:
    ...
    Sb "In un certo senso, sì. Ci rende piuttosto indipendenti e mantiene il tutto a livello locale."
...
translate italiantl sebastianquestions_5a7a1f3a:
    ...
    Sb smile b "Sono un gruppetto amichevole, per la maggior parte. Ovviamente si incontrano anche certi tipi sgradevoli nel mio mestiere, ma per fortuna, sembrano essere una minoranza."
...
translate italiantl sebastianquestions_9c35b044:
    ...
    Sb normal b "Ho avuto anche un piccolo trauma culturale quando all'inizio sono venuto qui con tutte le specie diverse che vivono qui assieme, ma a questo ci ha pensato la mia formazione in polizia." # "a bit of" -> "a little"
...
translate italiantl sebastianquestions_f498636a:
    ...
    Sb "Trovai un po' strano che al pezzo grosso in persona toccasse di mostrare i rudimenti al campagnolo, però."
...
translate italiantl sebastianquestions_fcac93fc:
    ...
    Sb "Pensai che la vedesse come una sfida o che volesse scoraggiarmi, ma onestamente, è stato fantastico. Tutti quanti qui hanno molta fiducia in lui."
...
translate italiantl sebastianquestions_9515f14d:
    ...
    Sb normal b "In confronto alla mia città natale, è stato un cambiamento piuttosto interessante. Da un lato, hai ogni genere di persone diverse con ogni genere di diversi punti di forza, abilità e formazioni che possono rendere il tuo lavoro molto più facile."
...
translate italiantl sebastianquestions_6c768088:
    ...
    Sb "Dall'altro, crea anche ogni genere di nuovi problemi che non mi sarei mai aspettato. Non dimenticherò la prima volta che ho dovuto inseguire un taccheggiatore che si dà il caso fosse anche un volatore."
...
translate italiantl sebastianquestions_fe4fce32:
    ...
    Sb smile b "Segreti? Questa città non è che abbia dei segreti."
...
translate italiantl sebastianquestions_17584c14:
    ...
    Sb disapproval b "Non che io sappia, per lo meno."
...
translate italiantl sebastianquestions_921c62dd:
    ...
    c "Forse semplicemente non appartieni ancora alla cerchia più ristretta."
...
translate italiantl sebastianquestions_cc1e9e12:
    ...
    Sb smile b "Come membro delle forze di polizia, penserei di aver visto tutto quello che c'era da vedere." # "I'd get to see" -> "I had seen"
...
translate italiantl sebastianquestions_bea7ba6b:
    ...
    Sb normal b "Comunque sia, non credo che la nostra città abbia niente di così speciale."
...
translate italiantl sebastiancont_1c0040b6:
    ...
    Sb smile b "Ma ehi, non sono l'unico qui ad essere nuovo. Quali sono le tue impressioni? Buono, brutto, ...cattivo?"

# game/xsebastian.rpy:551
translate italiantl sebastiancont_4a4242d6:

    # Sb disapproval b "No comment?"
    Sb disapproval b "Niente da dire?"
...
translate italiantl sebastiancont_215431ad:
    ...
    Sb disapproval b "Oh, è comprensibile con tutto quello che sta accadendo."
...
translate italiantl sebastiancont_872b0904:
    ...
    c "Forse è un bene che molti posti fossero chiusi. Non sono sicurə che avrei gradito molto un altro giro turistico."
...
translate italiantl sebastiancont_a23828c2:
    ...
    Sb smile b "Suppongo tu non sia unə corridorə come me. A noi non dispiace restare in piedi."
...
translate italiantl sebastiancont_2da0643b:
    ...
    Sb drop b "Divertente? Non è qualcosa che mi aspetterei che dicessi dopo che ti abbiamo mostrato un corpo il primo giorno."
...
translate italiantl sebastiancont_cc845e57:
    ...
    c "Ehi, se [Br] ha detto che andava fatto, allora fa parte del lavoro."
...
translate italiantl sebastiancont_c29de72b:
    ...
    c "Se vi serve il mio aiuto, sono felice di darvelo. Sai, promuovere la buona volontà e tutto il resto." # "YOU KNOW, fostering goodwill and all that"
...
translate italiantl sebastiancont_9d878b7c:
    ...
    Sb smile b "Comunque, che ne dici se ci divertiamo un po'?" # "how about WE HAVE some fun"

# game/xsebastian.rpy:597
translate italiantl sebastiancont_ccbacb5a:

    # c "What kind of fun are you talking about?"
    c "Di che tipo di divertimento parliamo?" # "you" -> "we"
...
translate italiantl sebastiancont_f9eb06a7:
    ...
    Sb "Solo un giochino chiamato {i}Bastioni{/i}. Mai sentito?" # wording

# game/xsebastian.rpy:605
translate italiantl sebastiancont_63856961:

    # c "Can't say I have."
    c "Non posso dire di sì."
...
translate italiantl sebastiancont_7e88c41c:
    ...
    Sb "Lo giochiamo spesso in saletta per passare il tempo. È divertente, anche se a volte le cose possono farsi piuttosto accese."

# game/xsebastian.rpy:609
translate italiantl sebastiancont_b02cd128:

    # Sb "Let me go over the rules."
    Sb "Lascia che ti spieghi le regole." # "go over" -> "explain you"
...
translate italiantl gamestart_b64e4697:
    ...
    Sb "Come puoi vedere, ciascuno di noi inizia con tutte le carte di un dato seme nella sua mano. Tu hai i quadri e io avrò i cuori." # must match line 681
...
translate italiantl sebgameexplanation_ed0549b5:
    ...
    Sb "Quella che vedi nel centro è la {i}riga di mezzo{/i}, che è una linea di carte rimescolate da un altro seme."
...
translate italiantl sebgameexplanation_67880e0d:
    ...
    Sb "In questo modo, ogni partita sarà unica dato che la riga di mezzo cambia sempre fra una partita e l'altra."
...
translate italiantl sebgameexplanation_33b32518:
    ...
    Sb "Ora, ecco come funziona il gioco: giocheremo un turno per ogni carta nella riga di mezzo, a partire da quella che vedi in fondo a sinistra." # corrected lowercase letter
...
translate italiantl sebgameexplanation_718c24c0:
    ...
    Sb "Durante ogni turno, entrambi decidiamo quale carta giocare e ce la mettiamo a faccia in giù—in questo modo." # corrected em-dash
...
translate italiantl sebgameexplanation_39ba47ec:
    ...
    Sb "Una volta che entrambi abbiamo giocato una carta, la giriamo. La carta più alta vince il turno, e chiunque l'abbia giocata ottiene un punto."
...
translate italiantl sebgameexplanation_8bf06079:
    ...
    Sb "Per chiarire, il due è la carta più bassa e il re è quella più alta. L'asso è una carta speciale—batte tutte le figure, ma perderà contro qualsiasi numero." # corrected em-dash; "2" -> "two" for elegance
...
translate italiantl sebgameexplanation_09fa8238:
    ...
    Sb "Ora, contano anche le carte dalla riga di mezzo, quindi è possibile che nessuno di noi ottenga il punto per un turno."
...
translate italiantl sebgameexplanation_d93d316b:
    ...
    Sb "Se c'è un pareggio, non c'è un chiaro vincitore fra le tre carte, oppure la riga di mezzo ha la carta più alta, nessun giocatore otterrà un punto per quel turno. Tuttavia, il turno successivo darà al vincitore un punto extra per compensare."
...
translate italiantl sebgamestart_0784d620:
    ...
    Sb "Perciò, questo gioco sta tutto nelle finte e nei giochetti mentali. Possiamo sempre vedere quali carte sono state giocate, quindi ciascuno di noi sa esattamente cosa resta all'altro giocatore."

# game/xsebastian.rpy:812
translate italiantl sebgamestart_1d04c7ae:

    # Sb "Alright, are you ready?"
    Sb "D'accordo, sei prontə?"
...
translate italiantl sebgamestart_14135413:
    ...
    Sb "Non preoccuparti, ci andrò piano con te."

# game/xsebastian.rpy:818
translate italiantl sebgamestart_81b3c032:

    # Sb "Take all the time you need to make your selection."
    Sb "Prenditi tutto il tempo che ti serve per fare la tua scelta." # "selection" -> "choice"
...
translate italiantl sebgamestart_96aa7bca:
    ...
    Sb "Ahh, un cinque come prima carta è un inizio interessante." # "5" -> "five" for elegance
...
translate italiantl sebgamestart_0470e52e:
    ...
    Sb "Potresti provare a superarla e giocare qualcosa di più alto, ma se io farò lo stesso, non sai quanto andrei in alto non solo per battere il cinque, ma anche la tua carta più alta." # "5" -> "five" for elegance
...
translate italiantl sebgamestart_da4cc757:
    ...
    Sb "In alternativa, potresti contare sul fatto che io cerchi di battere una carta più alta e giocarne invece una bassa, facendomi così sprecare la mia."

# game/xsebastian.rpy:849
translate italiantl sebgamestart_40ac4eec:

    # Sb "What's it going to be, [player_name]?"
    Sb "Che cosa scegli, [player_name]?"
...
translate italiantl sebgamestart_82ea7abf:
    ...
    Sb "Come puoi vedere, ho giocato un misero due solo per vedere cosa sarebbe successo." # "2" -> "two" for elegance
...
translate italiantl sebgamestart_e99f54b7:
    ...
    Sb "Conoscere il tuo avversario e le sue inclinazioni è importante tanto quanto analizzare le potenziali mosse e strategie."
...
translate italiantl sebgamestart_27f4e54d:
    ...
    Sb "Il primo punto è tuo, ma adesso devi chiederti: ne è valsa la pena?" # corrected lowercase letter
...
translate italiantl sebgamestart_95450ed5:
    ...
    Sb "Un pareggio. Immagino che abbiamo provato entrambi a fare la stessa cosa qui."
...
translate italiantl sebgamestart_9b41fa1f:
    ...
    Sb "Hai giocato il tuo asso, eh? Non esattamente la mossa migliore per il primo turno."
...
translate italiantl sebgamestart_27c639f4:
    ...
    Sb "Il re ci pone di fronte a un interessante grattacapo, specie quando ti arriva presto e molte carte sono ancora disponibili. Questa però te la lascerò capire da solə." # "when most cards" -> "and most cards"
...
translate italiantl sebgamestart_9c42457b:
    ...
    Sb "Sembra un pareggio. Naturalmente, la sola carta che batte un re è l'asso, ma giocarla qui sarebbe un errore da novellini. Decisamente vai più sul sicuro se qui ti sbarazzi di una carta bassa." # "to [just]" -> "if you"
...
translate italiantl sebgamestart_5ae39e73:
    ...
    Sb "Hai fatto la cosa più scontata e hai giocato l'asso, la sola carta che batte un re. Dato che il mio tre batte il tuo asso, però, questo turno è considerato un pareggio." # "3" -> "three" for elegance
    Sb "Potresti pensare che non sia poi così male, ma averti portato via l'asso con un misero tre mi dà un grande vantaggio durante il resto del gioco." # split to fit three lines; corrected "A big advantage"; "3" -> "three" for elegance
...
translate italiantl sebgamestart_edd96708:
    ...
    Sb "Finora sembra sia piuttosto alla pari."

# game/xsebastian.rpy:2464
translate italiantl sebgamestart_edd96708_1:

    # Sb "Looks like it's pretty even so far."
    Sb "Finora sembra sia piuttosto alla pari." # see line 2460
...
translate italiantl sebgamestart_fe7a136a:
    ...
    Sb "Non si mette benissimo per te."
...
translate italiantl sebgamestart_6e7a07bf:
    ...
    Sb "Diamine, sei più forte di quanto pensassi. Sei sicurə di non averci mai giocato prima?"
...
translate italiantl sebgamestart_be1f1867:
    ...
    Sb "Sul serio, come ho potuto perdere sette volte di fila? Immagino che questa l'hai vinta tu, [player_name]. Non sarò in grado di rimontare, quindi finiamola tanto per finirla."
...
translate italiantl sebgamestart_d85f3682:
    ...
    Sb "Mi spiace dirlo, ma hai appena perso. Il meglio che potresti fare adesso è perdere di un punto, anche se tu vincessi ogni turno dopo di questo."
...
translate italiantl sebgamestart_4fe2895a:
    ...
    Sb "Questo è il punto di mezzo, quindi adesso si farà davvero sul serio. Chiunque può ancora vincere."
...
translate italiantl sebgamestart_558807b7:
    ...
    Sb "La cosa si fa interessante."

# game/xsebastian.rpy:3847
translate italiantl sebgamestart_558807b7_1:

    # Sb "This is getting interesting."
    Sb "La cosa si fa interessante." # see line 3843
...
translate italiantl sebgamestart_82c4aa76:
    ...
    Sb smile b "Wow, ma guarda un po'. Ti ho proprio massacrato."
...
translate italiantl sebgamestart_ebb1d8b3:
    ...
    c "Hai appena battuto qualcuno che ci giocava per la prima volta, congratulazioni."

# game/xsebastian.rpy:4432
translate italiantl sebgamestart_4ec571eb:

    # Sb "{cps=10}E-R-A-D-I-C-A-T-E-D{/cps}{cps=1}.{/cps}"
    Sb "{cps=10}M-A-S-S-A-C-R-A-T-O{/cps}{cps=1}.{/cps}"
...
translate italiantl sebgamestart_ccf23f17:
    ...
    c "E va bene, si sta trasformando in un grave caso di {i}sindrome da pessimo vincitore{/i}."
...
translate italiantl sebgamestart_5f7ec2a9:
    ...
    Sb "Solo quando il mio avversario si fa completamente {cps=10}{i}massacrare{/i}{/cps} come hai appena fatto tu."
...
translate italiantl sebgamestart_919f76e1:
    ...
    Sb "Nessuno mi crederà al dipartimento quando glielo racconterò."

# game/xsebastian.rpy:4468
translate italiantl sebgamestart_d06ff551:

    # c "So, who won?"
    c "Dunque, chi ha vinto?"
...
translate italiantl sebgamestart_eed7d84e:
    ...
    Sb disapproval b "Nessuno. È un pareggio. E il pareggio più pareggiato che abbia mai visto, se mi è consentito dirlo."

# game/xsebastian.rpy:4472
translate italiantl sebgamestart_b3c84761:

    # c "You certainly can."
    c "Puoi dirlo senz'altro."
...
translate italiantl sebgamestart_6484653e:
    ...
    Sb smile b "Pare che tu abbia vinto, in piena regola. Ovviamente ci sono andato piano con te. Lo sai questo, giusto?"
...
translate italiantl _call_syscheck_61_c06c9c26:
    ...
    # s "You won a game of {i}Bastion Breach{/i}!"
    s "Hai vinto una partita a {i}Bastioni{/i}!" # see line 4416
...
translate italiantl _call_syscheck_61_116bf77a:
    ...
    s "Hai vinto una partita a {i}Bastioni{/i}. Congratulazioni."
...
translate italiantl _call_syscheck_61_73f5714e:
    ...
    Sb "Non posso farci niente, immagino. Sono troppo bravo."
...
translate italiantl _call_syscheck_61_48146fcd:
    ...
    c "Hai battuto qualcuno che ci giocava per la prima volta. Congratulazioni." # see line 4430
...
translate italiantl _call_syscheck_61_b696c231:
    ...
    Sb normal b "Queste le metterò via."
...
translate italiantl _call_syscheck_61_9bd5ae94:
    ...
    Sb shy b "Magari un'altra volta. Si sta facendo un po' tardi adesso."
...
translate italiantl _call_syscheck_61_70e2bce7:
    ...
    Sb smile b "Ehi, forse la prossima volta potresti insegnarmi un gioco di carte degli umani."
...
translate italiantl sebastianskip_132018c8:
    ...
    Sb disapproval b "Forse dovremmo dormire un po' adesso. Immagino che domani sarà una giornata non meno intensa di oggi, e non dimentichiamo che dovrò alzarmi presto per fare rapporto su tutto questo."

# game/xsebastian.rpy:4586
translate italiantl sebastianskip_352dd762:

    # c "Don't leave out the part where I totally won."
    c "Non lasciare fuori la parte in cui ho stravinto."
...
translate italiantl sebastianskip_ab862e3d:
    ...
    c "Non so quanto sarebbe sicuro tenere acceso un fuoco durante la notte."

# game/xsebastian.rpy:4619
translate italiantl sebastianskip_536a956f:

    # Sb "You're right, but I wasn't talking about that."
    Sb "Hai ragione, ma non era di questo che parlavo."
...
translate italiantl sebastianskip_3330ba00:
    ...
    Sb "Comunque sia, la sola coperta che posso offrire sono io."
...
translate italiantl sebastianskip_dd89a6fe:
    ...
    Sb "Capisco. Passa una buona notte, allora." # see line 4604

# game/xsebastian.rpy:4646
translate italiantl sebastianskip_0876da50_1:

    # c "Good night, Sebastian."
    c "Buonanotte, [Sb]." # see line 4606
...
translate italiantl strings:
    ...
    new "In effetti, intendevo solo che non devi essere così formale con me."
    ...
    new "Credo che preferirei restarmene qui."

    # xsebastian.rpy:270
    old "So I'm supposed to just sleep on the ground?"
    new "Perciò dovrei semplicemente dormire per terra?"
    ...
    new "Finora hai fatto un ottimo lavoro. Non ti preoccupare."

    # xsebastian.rpy:340
    old "With the whole murder situation going on, you should be careful that it doesn't end more than just your career."
    new "Con tutta la situazione degli omicidi, dovresti stare attento che non finisca più che la tua sola carriera." # "with the whole murder situation [going on]"

    # xsebastian.rpy:340
    old "Better hope these walls aren't going to cave in, then."
    new "Speriamo che queste pareti non cederanno, allora."

    # xsebastian.rpy:434
    old "What can you tell me about the land?"
    new "Cosa puoi dirmi del territorio?"

    # xsebastian.rpy:434
    old "What can you tell me about the people?"
    new "Cosa puoi dirmi delle persone?"

    # xsebastian.rpy:434
    old "What is it like to work with Bryce?"
    new "Com'è lavorare con [Br]?"

    # xsebastian.rpy:434
    old "What's it like having so many different species on the force?"
    new "Com'è avere così tante specie diverse in polizia?"

    # xsebastian.rpy:434
    old "Do you have any special recommendations or secrets I should know about this town?"
    new "Hai qualche raccomandazione speciale o qualche segreto che dovrei sapere su questa città?"

    # xsebastian.rpy:545
    old "It's been a bit hectic so far."
    new "Finora è stato un po' frenetico."

    # xsebastian.rpy:545
    old "It's been fun so far."
    new "Finora è stato divertente."
    ...
    new "Hai già il mio, di cuore."

    # xsebastian.rpy:681
    old "You stole all those hearts, didn't you?"
    new "Allora sei un rubacuori, dico bene?"

    # xsebastian.rpy:761
    old "Yes. Let's get started."
    new "Sì. Iniziamo pure."

    # xsebastian.rpy:761
    old "No. Please explain it again."
    new "No. Spiegamelo di nuovo, per favore."

    # xsebastian.rpy:4564
    old "I don't know any card games."
    new "Non conosco nessun gioco di carte."

    # xsebastian.rpy:4600
    old "It's pretty cold."
    new "È piuttosto freddo."
